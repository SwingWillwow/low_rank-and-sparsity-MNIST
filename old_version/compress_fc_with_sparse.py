...
def low_rank_conv2d(x, W, r, name):
    pass
...
h_fc1 = ABS_fc_layer(flatten_pooling, [7*7*64, 1024], name='fc1', r=10)
...
h_fc2 = ABS_fc_layer(h_fc1_after_drop, [1024, 10], name='fc2', r=10)
...
with tf.Session() as sess:
    ...
    for i in range(30 * epoch_size):
        ...
        for s in sparse_weights:
            ...
            add_one = tf.sparse_to_dense(indices, s.shape, values)
            tf.assign_sub(s, s)
    ...
    saver.save(sess, 'model/ABS/ABS.ckpt')
